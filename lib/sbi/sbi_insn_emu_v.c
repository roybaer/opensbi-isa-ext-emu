...
#define VLMAX_BYTES (8 * 16)
#endif

#if CONFIG_EMU_ZVBB_VLEN_256
#define VLMAX_BYTES (8 * 32)
#endif

#if CONFIG_EMU_ZVBB_VLEN_512
#define VLMAX_BYTES (8 * 64)
#endif

#if CONFIG_EMU_ZVBB_VLEN_1024
#define VLMAX_BYTES (8 * 128)
#endif
