...
The following ISA extensions are currently supported, **if enabled via menuconfig**:
...
1. Zicbom emulation depends on OpenSBI's FDT CMO helper library.
...
This is now outdated, but the use of OpenSBI's recently integrated native
SpacemiT K1/M1 support remains untested.
